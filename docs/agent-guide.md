...
5. Preserve the SQLite community schema and tests together whenever auth, thread, DM request, DM acceptance, or save behavior changes.
...
- SQLite-backed auth, bootstrap, room chat, DM requests/acceptance, direct-message threads, and save APIs stay covered by direct tests.
