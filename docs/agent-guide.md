...
5. Preserve the SQLite community schema and tests together whenever auth, public/private room rules, room invites, DM request flow, automod mutes, or save behavior changes.
...
- SQLite-backed auth, bootstrap, public/private room access, room invite notifications, DM requests/acceptance, direct-message threads, automod mutes, and save APIs stay covered by direct tests.
